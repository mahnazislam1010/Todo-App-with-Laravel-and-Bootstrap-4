...
@section('content')
    <div class="w-100 h-100 d-flex justify-content-center align-items-center">
        <div class="text-center" style="width: 40%">
            ...
            <h3 class="text-white pt-2">My Todo List:</h3>
                ...
                @forelse($todos as $todo)
                    ...
                    <div class="mr-4 d-flex align-items-center">
                        ...
                        <form action="{{route('todo.update',$todo->id)}}" method="post">
                            ...
                            <button class="btn btn-success mr-2">Mark it as Completed</button>
                        </form>
                        @else
                        <form action="{{route('todo.update',$todo->id)}}" method="post">
                            @method('PUT')
                            ...
                            <button class="btn btn-warning mr-2">Mark it as Uncompleted</button>
                        </form>
                        @endif
                    ...
                    <h3>Nothing added in your Todo List</h3>
